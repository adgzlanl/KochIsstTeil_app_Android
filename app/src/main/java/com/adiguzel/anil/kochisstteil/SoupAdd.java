...
public class SoupAdd extends AppCompatActivity {
    EditText editMenuName;
    EditText editRecipe;
    EditText editDuration;
    private static final String LoginUrl="https://kochisstteil.herokuapp.com/soupAdd";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_soup_add);
...

    {
        String email="selo";
        String password="123";
        String addSoup=editMenuName.getText().toString();
                    ...
                    public void onResponse(JSONObject response)
                    {
                        ...
                        try {
                            ...
                            if (message=="true")
                            {
                                ...
                                Intent intent = new Intent(SoupAdd.this, Soup.class);
