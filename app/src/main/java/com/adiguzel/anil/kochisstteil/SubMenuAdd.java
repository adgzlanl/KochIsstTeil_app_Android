...
public class SubMenuAdd extends AppCompatActivity {
    EditText editMenuName;
    EditText editRecipe;
    EditText editDuration;

    private static final String LoginUrl="https://kochisstteil.herokuapp.com/subMenuAdd";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sub_menu_add);
...

    {
        ...
        String addSubMenu=editMenuName.getText().toString();
                    ...
                    public void onResponse(JSONObject response)
                    {
                        ...
                        try {
                            ...
                            if (message=="true")
                            {
                                ...
                                Intent intent = new Intent(SubMenuAdd.this, SubMenu.class);
