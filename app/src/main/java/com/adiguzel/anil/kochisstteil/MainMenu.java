...
public class MainMenu extends AppCompatActivity {
    ...
    private static final String URL_DATA="https://kochisstteil.herokuapp.com/mainMenuRead";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Intent intent = new Intent(MainMenu.this, MainMenuAdd.class);
                ...
                (Request.Method.POST, URL_DATA, jsonObj, new Response.Listener<JSONObject>()
                {
                    ...
                    public void onResponse(JSONObject response)
                    {
                        ...
                        try {
                            ...
                            JSONArray array=response.getJSONArray("mainMenu");

                            for (int i=0;i<array.length();i++)
                            {
                                JSONObject o =array.getJSONObject(i);

                                MenuList item=new MenuList(o.getString("mainMenu"),o.getString("recipe"),o.getString("_id"),o.getString("duration"));
                                listItems.add(item);
                            }

                            adapter=new MainMenuAdapter(listItems,getApplicationContext());
