...
public class Salad extends AppCompatActivity {
    ...
    private static final String URL_DATA="https://kochisstteil.herokuapp.com/saladRead";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Intent intent = new Intent(Salad.this, SaladAdd.class);
    ...
    private void logout()
    {
        ...
        Intent intent = new Intent(Salad.this, Login.class);
        startActivity(intent);
        finish();
    }
                ...
                (Request.Method.POST, URL_DATA, jsonObj, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            JSONArray array = response.getJSONArray("salad");

                            for (int i = 0; i < array.length(); i++) {
                                JSONObject o = array.getJSONObject(i);

                                MenuList item = new MenuList(o.getString("salad"), o.getString("recipe"), o.getString("_id"), o.getString("duration"));
                                listItems.add(item);
                            }

                            adapter = new SaladAdapter(listItems, getApplicationContext());
